...
" Vim group
hi Comment      guifg=DarkSeaGreen  gui=italic
hi Number       guifg=black
hi Float        guifg=black
hi Boolean      guifg=#0048ff
" all the string inherit from this
hi String       guifg=SteelBlue3   gui=none
...
"defines php tag <?php>
hi Delimiter 					guifg=Orchid3	gui=bold 


" Html colors 
hi htmlTag						guifg=SteelBlue
hi htmlEndTag					guifg=SteelBlue
hi htmlTagName					guifg=Brown	
hi htmlArg						guifg=red3
"Php 
"hi phpRegion					guifg=Blue
hi phpParent					guifg=Black
"Vim Syntax 
hi vimHighlight					guifg=Brown
hi vimHiGroup					guifg=Orchid3 
